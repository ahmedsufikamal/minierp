...
- [x] Wave 2 stock MVP completion alignment
- [-] Wave 3 sales chain MVP
- [-] Wave 4 procurement chain MVP
- [-] Wave 5 CRM MVP
- [-] Wave 6 manufacturing + subcontracting + quality MVP
- [-] Wave 7 projects + support + communication + telephony MVP
- [-] Wave 8 HR & payroll MVP
- [-] Wave 9 assets + maintenance + regional MVP
- [-] Wave 10 POS + portal MVP
- [-] Wave 11 integrations + EDI + bulk + utilities MVP
