...
import { type EdiPermission } from "@/modules/edi/domain/types";

const permissionAliases: Record<EdiPermission, string[]> = {
  "edi.code.read": ["edi.read"],
  "edi.code.write": ["edi.write"],
  "edi.transport.read": ["edi.read"],
  "edi.transport.write": ["edi.write"],
  "edi.transport.manage": ["edi.manage", "edi.write"],
};

function hasPermission(
  ctx: Awaited<ReturnType<typeof getPlatformRequestContext>>,
  permission: EdiPermission,
): boolean {
...
export async function withEdiAuth(
  request: Request,
  permission: EdiPermission,
