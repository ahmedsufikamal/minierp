...
import { type CommunicationPermission } from "@/modules/communication/domain/types";

const permissionAliases: Record<CommunicationPermission, string[]> = {
  "communication.window.read": ["communication.read", "support.read"],
  "communication.window.write": ["communication.write", "support.write"],
  "communication.log.read": ["communication.read", "support.read"],
  "communication.log.write": ["communication.write", "support.write"],
};
...
export async function withCommunicationAuth(
  request: Request,
  permission: CommunicationPermission,
