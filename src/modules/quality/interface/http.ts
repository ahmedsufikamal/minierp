...
import { type QualityPermission } from "@/modules/quality/domain/types";

const permissionAliases: Record<QualityPermission, string[]> = {
  "quality.inspection.read": ["quality.read", "manufacturing.read", "buying.read"],
  "quality.inspection.write": ["quality.write", "manufacturing.write", "buying.write"],
  "quality.inspection.approve": ["quality.approve", "quality.write", "manufacturing.approve", "buying.approve"],
...
export async function withQualityAuth(
  request: Request,
  permission: QualityPermission,
