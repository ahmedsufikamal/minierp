...
import { type AssetsPermission } from "@/modules/assets/domain/types";

const permissionAliases: Record<AssetsPermission, string[]> = {
  "assets.category.read": ["assets.read"],
  "assets.category.write": ["assets.write"],
  "assets.asset.read": ["assets.read"],
  "assets.asset.write": ["assets.write"],
  "assets.asset.post": ["assets.approve", "finance.approve", "assets.write"],
};

function hasPermission(ctx: Awaited<ReturnType<typeof getPlatformRequestContext>>, permission: AssetsPermission): boolean {
...
export async function withAssetsAuth(
  request: Request,
  permission: AssetsPermission,
