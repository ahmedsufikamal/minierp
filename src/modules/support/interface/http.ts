...
import { type SupportPermission } from "@/modules/support/domain/types";

const permissionAliases: Record<SupportPermission, string[]> = {
  "support.queue.read": ["support.read", "service-desk.read"],
  "support.queue.write": ["support.write", "service-desk.write"],
  "support.sla.read": ["support.read", "service-desk.read"],
  "support.sla.write": ["support.write", "service-desk.write"],
