...
import { type BulkPermission } from "@/modules/bulk/domain/types";

const permissionAliases: Record<BulkPermission, string[]> = {
  "bulk.job.read": ["bulk.read"],
  "bulk.job.write": ["bulk.write"],
  "bulk.job.run": ["bulk.manage", "bulk.write"],
};
