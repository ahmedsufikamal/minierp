...
import { type RegionalPermission } from "@/modules/regional/domain/types";

const permissionAliases: Record<RegionalPermission, string[]> = {
  "regional.profile.read": ["regional.read", "finance.read"],
  "regional.profile.write": ["regional.write", "finance.write"],
  "regional.profile.manage": ["regional.manage", "regional.write", "finance.approve"],
};

function hasPermission(ctx: Awaited<ReturnType<typeof getPlatformRequestContext>>, permission: RegionalPermission): boolean {
...
export async function withRegionalAuth(
  request: Request,
