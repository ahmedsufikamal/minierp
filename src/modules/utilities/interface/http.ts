...
import { type UtilitiesPermission } from "@/modules/utilities/domain/types";

const permissionAliases: Record<UtilitiesPermission, string[]> = {
  "utilities.task.read": ["utilities.read"],
  "utilities.task.write": ["utilities.write"],
  "utilities.task.manage": ["utilities.manage", "utilities.write"],
};

function hasPermission(
  ctx: Awaited<ReturnType<typeof getPlatformRequestContext>>,
  permission: UtilitiesPermission,
): boolean {
...
export async function withUtilitiesAuth(
  request: Request,
  permission: UtilitiesPermission,
