...
import { type PayrollPermission } from "@/modules/payroll/domain/types";

const permissionAliases: Record<PayrollPermission, string[]> = {
  "payroll.salary-structure.read": ["payroll.read", "finance.read"],
  "payroll.salary-structure.write": ["payroll.write", "finance.write"],
  "payroll.entry.read": ["payroll.read", "finance.read"],
  "payroll.entry.write": ["payroll.write", "finance.write"],
  "payroll.entry.post": ["payroll.approve", "finance.approve", "payroll.write"],
  "payroll.payslip.read": ["payroll.read", "finance.read"],
  "payroll.payslip.write": ["payroll.write", "finance.write"],
  "payroll.payslip.post": ["payroll.approve", "finance.approve", "payroll.write"],
};
...
export async function withPayrollAuth(
  request: Request,
  permission: PayrollPermission,
