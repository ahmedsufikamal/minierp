...
import { type PortalPermission } from "@/modules/portal/domain/types";

const permissionAliases: Record<PortalPermission, string[]> = {
  "portal.config.read": ["portal.read"],
  "portal.config.write": ["portal.write"],
  "portal.config.manage": ["portal.manage", "portal.write"],
};
