...
import { type HrPermission } from "@/modules/hr/domain/types";

const permissionAliases: Record<HrPermission, string[]> = {
  "hr.employee.read": ["hr.read"],
  "hr.employee.write": ["hr.write"],
  "hr.leave.read": ["hr.read"],
  "hr.leave.write": ["hr.write"],
  "hr.leave.approve": ["hr.approve", "hr.write"],
  "hr.attendance.read": ["hr.read"],
  "hr.attendance.write": ["hr.write"],
  "hr.expense.read": ["hr.read", "finance.read"],
  "hr.expense.write": ["hr.write", "finance.write"],
  "hr.expense.approve": ["hr.approve", "finance.approve", "hr.write"],
};

function hasPermission(ctx: Awaited<ReturnType<typeof getPlatformRequestContext>>, permission: HrPermission): boolean {
...
export async function withHrAuth(
  request: Request,
