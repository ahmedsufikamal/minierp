...
import { type PosPermission } from "@/modules/pos/domain/types";

const permissionAliases: Record<PosPermission, string[]> = {
  "pos.profile.read": ["pos.read"],
  "pos.profile.write": ["pos.write"],
  "pos.shift.read": ["pos.read"],
  "pos.shift.write": ["pos.write"],
  "pos.shift.manage": ["pos.manage", "pos.write"],
  "pos.sale.read": ["pos.read"],
  "pos.sale.write": ["pos.write"],
  "pos.sale.pay": ["pos.manage", "pos.write"],
};
