...
import { type SubcontractingPermission } from "@/modules/subcontracting/domain/types";

const permissionAliases: Record<SubcontractingPermission, string[]> = {
  "subcontracting.order.read": ["subcontracting.read", "buying.read", "procurement.read"],
  "subcontracting.order.write": ["subcontracting.write", "buying.write", "procurement.write"],
  "subcontracting.order.approve": ["subcontracting.approve", "buying.approve", "procurement.approve"],
  "subcontracting.receipt.read": ["subcontracting.read", "buying.read", "inventory.read"],
  "subcontracting.receipt.write": ["subcontracting.write", "buying.write", "inventory.write"],
  "subcontracting.receipt.accept": ["subcontracting.approve", "buying.approve", "quality.read"],
};

function hasPermission(
  ctx: Awaited<ReturnType<typeof getPlatformRequestContext>>,
  permission: SubcontractingPermission,
): boolean {
...
export async function withSubcontractingAuth(
  request: Request,
  permission: SubcontractingPermission,
