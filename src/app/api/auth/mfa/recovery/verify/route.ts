...
import { mfaRecoveryVerifySchema } from "@/modules/iam/interface/schemas";
...
export async function POST(request: Request) {
  try {
    ...
    const body = await parseBody(request, mfaRecoveryVerifySchema);
    ...
    await getIdentityProvider().verifyRecoveryCode({
